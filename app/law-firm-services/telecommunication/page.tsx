...
export const metadata: Metadata = {
  title: "Telecommunication law service | Attah Ochinke and Co. ",
  description:
    "Expert telecommunication legal services in Nigeria. Navigate regulations, mergers, acquisitions, and compliance with Attah Ochinke and Co.",
};
