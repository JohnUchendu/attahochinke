...
export const metadata: Metadata = {
  title: "Project Finance law service | Attah Ochinke and Co. ",
  description:
    "Expert  project finance legal services in Nigeria. Navigate regulations, mergers, acquisitions, and compliance with Attah Ochinke and Co.",
};
